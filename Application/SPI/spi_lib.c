...
{
	return SPI_MSW_SendByteMSB(SPIx, wVal, pRVal);
}
...
{
	return SPI_MSW_SendByteLSB(SPIx, wVal, pRVal);
}
...
{
	return SPI_MSW_SendDataMSB(SPIx, pWVal, pRVal, length);
}
...
{
	return SPI_MSW_SendDataLSB(SPIx, pWVal, pRVal, length);
}
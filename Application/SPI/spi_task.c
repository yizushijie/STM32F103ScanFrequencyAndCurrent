...
{
	return SPILib_MSW_SendByteMSB(SPIx, wVal, pRVal);
}
...
{
	return SPILib_MSW_SendByteLSB(SPIx, wVal, pRVal);
}
...
{
	return SPILib_MSW_SendDataMSB(SPIx, pWVal, pRVal, length);
}
...
{
	return SPILib_MSW_SendDataLSB(SPIx, pWVal, pRVal, length);
}
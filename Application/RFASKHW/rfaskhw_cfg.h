...
extern "C" {
	...
	//===解码成功标志，0---解码成功，1---解码失败
		...
		#define DECA_PASS_PORT				DECA_PASS_PORT_D//BINA_PORT //YSEL0A_PORT_D
		#define	DECA_PASS_BIT				DECA_PASS_BIT_D//BINA_BIT  //YSEL0A_BIT_D
	#else
		#error "不支持的母板版本!"
	#endif
	...
	#elif (LNW_FT_ASK_MBOARD_VERSION==2)
		#define DECB_PASS_PORT				DECB_PASS_PORT_D//BINB_PORT//YSEL0B_PORT_D
		#define	DECB_PASS_BIT				DECB_PASS_BIT_D//BINB_BIT //YSEL0B_BIT_D
	#else
		#error "不支持的母板版本!"
	#endif
	//===SITEC的SOT，BIN，EOT,RST,DEC配置
